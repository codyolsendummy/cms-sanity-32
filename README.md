...
Create a secret that will be used to verify that webhook payloads came from Sanity infra, and set it as the value for `SANITY_REVALIDATE_SECRET`:
...
# If you didn't set CORS origin for prod earlier, now is the time, ensuring Preview Mode works
npx @sanity/cli cors add https://next-blog-sanity.vercel.app/ --credentials
# Update local .env
npx vercel env pull
```
...
[vercel-deploy]: https://vercel.com/new/clone?project-name=cms-sanity&repository-url=https://github.com/vercel/next.js/tree/canary/examples/cms-sanity&repository-name=cms-sanity&integration-ids=oac_hb2LITYajhRQ0i4QznmKH7gx&demo-image=https://user-images.githubusercontent.com/110497645/182727236-75c02b1b-faed-4ae2-99ce-baa089f7f363.png&demo-title=Blog%20using%20Next.js%20%26%20Sanity&demo-description=On-demand%20ISR%2C%20sub-second%20as-you-type%20previews&demo-url=https://github.com/vercel/next.js/blob/canary/examples/cms-sanity
